...
import { SubscriptionImportSourcesPageConnector } from '@pages/dashboard/subscription-import-sources/connectors'
            ...
            <Route element={<AuthGuard />}>
                ...
                <Route element={<MainLayout />} path={ROUTES.DASHBOARD.ROOT}>
                    ...
                    <Route path={ROUTES.DASHBOARD.MANAGEMENT.ROOT}>
                        ...
                        />
                        <Route
                            element={<SubscriptionImportSourcesPageConnector />}
                            path={ROUTES.DASHBOARD.MANAGEMENT.SUBSCRIPTION_IMPORT_SOURCES}
                        />
